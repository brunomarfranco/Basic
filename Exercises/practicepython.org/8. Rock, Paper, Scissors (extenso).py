...
while not end_game:
    ...
    elif P1_turn == "pedra" and P2_turn == "tesoura":
        print(f'Parabéns {player_1}, você venceu!')
    elif P1_turn == "pedra" and P2_turn == "papel":
        print(f'Parabéns {player_2}, você venceu!')

    elif P1_turn == "papel" and P2_turn == "pedra":
        print(f'Parabéns {player_1}, você venceu!')
    elif P1_turn == "papel" and P2_turn == "tesoura":
        print(f'Parabéns {player_2}, você venceu!')

    elif P1_turn == "tesoura" and P2_turn == "papel":
        print(f'Parabéns {player_1}, você venceu!')
    elif P1_turn == "tesoura" and P2_turn == "pedra":
        print(f'Parabéns {player_2}, você venceu!')
